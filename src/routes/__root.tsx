...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tap or Trap" },
      { name: "description", content: "Tap fast. Think faster." },
      { name: "theme-color", content: "#0a0b14" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "Tap or Trap" },
    ...
    links: [
      ...
      // Fonts are self-hosted so the packaged app renders identically offline.
      ...
      },
      {
        ...
        as: "font",
        type: "font/woff2",
        href: "/fonts/i7dPIFZifjKcF5UAWdDRYE98RWq7.woff2",
        crossOrigin: "anonymous",
      },
